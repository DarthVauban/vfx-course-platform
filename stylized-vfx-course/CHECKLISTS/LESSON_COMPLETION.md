...
Позначайте лише те, що підтверджено asset, capture, screenshot, measurement або письмовим поясненням.
...
- [ ] Є хоча б один запис `symptom → hypothesis → test → conclusion`.
- [ ] Проміжні values/masks/attributes перевірено окремо.
- [ ] Root cause пояснено, а не лише приховано symptom.
