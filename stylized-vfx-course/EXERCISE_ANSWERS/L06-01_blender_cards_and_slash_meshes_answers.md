...
Heavy має більший очікуваний screen coverage; Precision може потребувати camera-facing support; Fast геометрично найдешевший, але може зникати на відстані. Це дизайнерські ризики, а не виміряна вартість UE.
