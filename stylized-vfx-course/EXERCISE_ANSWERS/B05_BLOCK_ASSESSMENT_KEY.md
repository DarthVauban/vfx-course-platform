...
- першопричина відповідає доказам — 1;
- цільове виправлення — 1;
- capture після виправлення за тієї самої умови — 1.

Косметичний after-crop без установленої першопричини отримує максимум 2.
...
- Спостереження покриття екрана прозорими елементами/overdraw — 1.
