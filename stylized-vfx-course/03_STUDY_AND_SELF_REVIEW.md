# Система самостійного навчання й самооцінювання
...
- Які критерії засвоєння ще не виконано?
...
- один ризик для продуктивності;
- один художній principle;
- одну помилку та її першопричину.
...
- Чи direction of motion підтримує ігрову дію?
- Чи є anticipation, activation, main action, contact, dissipation і residue там, де вони потрібні?
- Чи другорядний рух запізнюється, а не запускається одночасно?
- Чи effect читається на світлому, середньому й темному фоні?
- Чи покриття екрана відповідає gameplay importance?
